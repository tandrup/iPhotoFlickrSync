...
@property (copy, readonly) NSString *previewFilename;  // The name of the preview file.
@property (copy, readonly) NSString *previewPath;  // The path to the preview file.
@property NSInteger rating;  // The star rating (0 through 5).
